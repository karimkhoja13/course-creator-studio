...
import { deleteNestedItem, updateNestedItem } from "../utils/courseHelpers";
...
export interface CourseState {
  ...
  // Unit actions
  addUnit: (chapterId: number, unit: Omit<Unit, "id" | "attachments">) => void;
  updateUnit: (
    chapterId: number,
    unitId: number,
          ...
          course: {
            ...
            chapters: updateNestedItem(
              ...
              chapter => ({
                ...
                units: updateNestedItem(chapter.units, unitId, unit => ({
                  ...unit,
                  attachments: deleteNestedItem(unit.attachments, attachmentId),
                })),
              }),
            ),
          },
        ...
        set(state => ({
          ...
          course: {
            ...
            chapters: updateNestedItem(
              ...
              chapter => ({
                ...chapter,
                fluidDefense: deleteNestedItem(chapter.fluidDefense, defenseId),
              }),
            ),
          },
        })),
